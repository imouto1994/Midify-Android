...
import sg.edu.nus.midi.event.MidiEvent;
import sg.edu.nus.midi.event.NoteOn;
import sg.edu.nus.midi.event.meta.EndOfTrack;
import sg.edu.nus.midi.event.meta.Tempo;
import sg.edu.nus.midi.event.meta.TimeSignature;
import sg.edu.nus.midi.util.MidiUtil;
import sg.edu.nus.midi.util.VariableLengthInt;
