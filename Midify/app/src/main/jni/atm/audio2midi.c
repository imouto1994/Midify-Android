...
jobjectArray Java_sg_edu_nus_midify_record_WavToMidiConverter_wav2midi(JNIEnv* env,
        jobject thiz) {
...
jstring Java_sg_edu_nus_midify_record_PcmToWavConverter_pcm2wav(JNIEnv* env,
        jobject thiz) {
